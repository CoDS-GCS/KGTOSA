...
class Trainer:
    ...
    def train(self,
       ...
       ###################
        ...
        for epoch in range(self.epoch_max):
            ...
            # lr scheduler
            criterion_val_loss = data_dic['self']['loss']
            if scheduler is not None:
                scheduler.step(criterion_val_loss)

            # early stop
            criterion_val_acc = data_dic['self']['acc']
    ...
    def inference(self,
        ...
        loader_dict = {'val': {'self': self_val_loader },
                       'test': {'self': self_test_loader}}
