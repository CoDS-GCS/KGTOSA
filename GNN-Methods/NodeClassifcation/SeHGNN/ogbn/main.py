...
def main(args):
    ...
    g, init_labels, num_nodes, n_classes, train_nid, val_nid, test_nid, evaluator,tgt_type = load_dataset(args)
    ...
    if args.dataset in ['ogbn-proteins', 'ogbn-products']: # homogeneous
        ...
        feats = {k: g.ndata.pop(k) for k in keys}
                         ...
                         'DBLP_Paper_Venue_FM_Literals2Nodes_SY1900_EY2021_50Class',                         'DBLP_Paper_Venue_StarQuery_allPapers_RemoveAllLiterals_SY1900_EY2021_50Class',
                         'YAGO_FM200','YAGO_Star200','OGBN-MAG_FM_PD','OGBN-MAG_StarQuery_PD','YAGO_FM','YAGO_Star']: # multi-node-types & multi-edge-types
        # tgt_type = 'P'
        # tgt_type = 'paper'
    ...
    for stage in range(args.start_stage, len(args.stages)):
        ...
        if args.label_feats:
            ...
            elif args.dataset in ['ogbn-mag','OGBN-MAG_FM','OGBN-MAG_StarQuery','DBLP_Paper_Venue_FM_StarQuery_allPapers_RemoveAllLiterals_SY1900_EY2021_50Class','DBLP_Affliation_Country_FM_Author_Affaliation_RemoveAllLiterals',                                 'DBLP_Paper_Venue_FM_Literals2Nodes_SY1900_EY2021_50Class',                                 'DBLP_Paper_Venue_StarQuery_allPapers_RemoveAllLiterals_SY1900_EY2021_50Class',
...
def parse_args(args=None):
    dataset_metaInfo={'num tasks':1,
                      'eval metric':'acc',
                      'task type':'multiclass classification',                     
                      'download_name':
                      # 'DBLP_Paper_Venue_StarQuery_allPapers_RemoveAllLiterals_SY1900_EY2021_50Class',
                      'YAGO_FM51',
                      'url':'/shared_mnt/YAGO/CreativeWork/YAGO_Star.zip'    
                      , 
                      # '/shared_mnt/DBLP/KGTOSA_DBLP_Datasets/DBLP_Paper_Venue_StarQuery_allPapers_RemoveAllLiterals_SY1900_EY2021_50Class.zip'
                      # 'download_name':'OGBN-MAG_StarQuery',
                      # 'url': '/shared_mnt/MAG_subsets/OGBN-MAG_StarQuery.zip', 
                      'num classes':350,
                      'version':1,
    ...
    parser.add_argument("--dataset_metaInfo", type=str, default=dataset_metaInfo)
    # parser.add_argument("--dataset_metaInfo", type=str, default=None)
    # parser.add_argument("--dataset", type=str, default="ogbn-mag")
    parser.add_argument("--dataset", type=str, default="YAGO_Star")        # parser.add_argument("--dataset", type=str, default="OGBN-MAG_StarQuery")
    # parser.add_argument("--dataset", type=str, default="DBLP_Affaliation_Country_StarQuery_Author_Affaliation_RemoveAllLiterals")
    # parser.add_argument("--root", type=str, default='../data/')
    # parser.add_argument("--root", type=str, default='/shared_mnt/DBLP/KGTOSA_DBLP_Datasets')
    parser.add_argument("--root", type=str, default='/shared_mnt/YAGO/CreativeWork/')
    parser.add_argument("--gpu", type=int, default=0)
    parser.add_argument("--cpu", action='store_true', default=True)
    parser.add_argument("--stages", nargs='+',type=int, default=[50, 50],
